...
Git/GitHub (entrega obrigatória para avaliação)
...
Categorias	✔	✔	✔	✔
Produtos	✔	✔	✔	✔
Movimentação Estoque	✔ (Entrada/Saída)	✔	—	—

Movimentação não possui "editar" ou "excluir" devido à integridade de histórico.

📌 Objetivo do Projeto

Fornecer uma solução prática para o gerenciamento completo do estoque, permitindo controlar produtos, fornecedores, categorias e movimentações de forma simples, funcional e organizada — seguindo as práticas solicitadas pelo estudo de caso e utilizando GitHub como parte do processo avaliativo.
